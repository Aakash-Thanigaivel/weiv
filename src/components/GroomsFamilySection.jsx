...
const familyFrames = [
  {
    ...
    images: [
      { name: 'bridefather', ext: 'png', alt: "Portrait of the bride's father", className: 'grooms-family-photo-portrait' },
      { name: 'bridemother', ext: 'png', alt: "Portrait of the bride's mother", className: 'grooms-family-photo-portrait grooms-family-photo-bridemother' },
      { name: 'bridemomnddad', ext: 'jpeg', alt: "Portrait of the bride's parents together", className: 'grooms-family-photo-together grooms-family-photo-bride-parents' },
    ],
  ...
  },
  {
    ...
    images: [
      { name: 'groomfather', ext: 'png', alt: "Portrait of the groom's father", className: 'grooms-family-photo-portrait' },
      { name: 'groommom', ext: 'png', alt: "Portrait of the groom's mother", className: 'grooms-family-photo-portrait' },
      { name: 'groommomnddad', ext: 'png', alt: "Portrait of the groom's parents together", className: 'grooms-family-photo-together' },
    ],
    initial: { opacity: 0, x: 34, y: 24 },
    animate: { opacity: 1, x: 0, y: 0 },
    delay: 0.24,
